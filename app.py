...
company_list= [
    r'C:\Users\elvin\Documents\Data Science\Stock analysis\individual_stocks_5yr\\AAPL_data.csv',
    r'C:\Users\elvin\Documents\Data Science\Stock analysis\individual_stocks_5yr\\AMZN_data.csv',
    r'C:\Users\elvin\Documents\Data Science\Stock analysis\individual_stocks_5yr\\GOOG_data.csv',
    r'C:\Users\elvin\Documents\Data Science\Stock analysis\individual_stocks_5yr\\MSFT_data.csv']
...
st.subheader("Daily return for " + selected_company)
...
st.subheader("Resampled Closing Price(Monnthly / Quaterly / Yearly)")

company_df.set_index('date', inplace= True)
resample_option= st.radio("Select Resample Frequency", ["Monthly", 'Quaterly', 'Yearly'])

if resample_option == 'Monhtly':
...
st.markdown("...")
st.markdown("**Note: The dashboard provide basic technical analysis using Python and Streamlit")
